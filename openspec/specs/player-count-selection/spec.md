...
Let the player choose between one- and two-player modes on the landing screen before vehicle picking, so the rest of the launch flow and the race know how many cars and views to set up.
